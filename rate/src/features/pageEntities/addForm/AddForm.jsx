...
import cl from './style/addForm.module.css';
...
<div className={cl.block_frame93}>
  <div className={cl.content_block_fram93}>
    <div className={''}>
      <div className={cl.conteiner_frame93_text_btn}></div>
      <div className={cl.conteiner_frame93_text_btn}>
        <span>
          Подпись
          <br />
          формат jpg, png
