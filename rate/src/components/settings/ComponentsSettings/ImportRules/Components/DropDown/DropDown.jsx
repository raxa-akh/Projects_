...
function DropDown({data = ["Не задано"], 
    ...
    return(
        <div className={styles.container}>
            <div className={isOpen ? `${styles.inner} ${styles.inner_open}` : `${styles.inner}`} style={isOpen ?{borderLeft: borderLeft,borderRight: borderRight,
            border: border} : {borderLeft: borderLeft,borderRight: borderRight,
