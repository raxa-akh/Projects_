...
import { PlayerDesktop } from '@/components/player-desktop'
  ...
  return (
    ...
    >
      ...
      <FormLink 
        ...
        href='/'
        marginBottom='8'
      >Зарегистрироваться</FormLink>
      <FormText>Если у вас еще нет аккаунта</FormText>
    </SignModalLayout>
  )
}
