...
function DesktopHeaderLayout(props: Props) {
	...
	return (
		<div className={cls.DesktopHeaderLayout}>
			<Link href={'/'} className={cls.DesktopHeaderLayout_logo}>
        <Image 
          src={'/assets/Logo.png'}
        ...
        />
			...
			{!props.disableLinks && <><nav className={cls.DesktopHeaderLayout_nav}>
				{links.map(l => (
					<Link
						key={l.href}
						href={l.href}
						className={classNames({
							[cls.active]: l.href === pathname
						})}
					>
						{l.label}
					</Link>
			...
			<button className={cls.DesktopHeaderLayout_notificationsButton}>
				{ !isNotificationsOpen ?<svg
					width='20'
					height='22'
					viewBox='0 0 20 22'
					fill='none'
